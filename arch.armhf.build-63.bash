...
rm -rf avrdude-6.3-arduino-$ARCHZIP
rm -f avrdude-6.3-arduino.org-$ARCHZIP.tar.bz2
mv avrdude-dist avrdude-6.3-arduino-$ARCHZIP
tar cfvj avrdude-6.3-arduino.org-$ARCHZIP.tar.bz2 avrdude-6.3-arduino-$ARCHZIP
